DELIMITER //
drop function if exists missing_monitoring;
CREATE FUNCTION missing_monitoring(container_id int, plug_on_day date, plug_on_time time) RETURNS integer DETERMINISTIC
BEGIN
...
select missing_monitoring(487,'2019-08-25','13:38:00');
