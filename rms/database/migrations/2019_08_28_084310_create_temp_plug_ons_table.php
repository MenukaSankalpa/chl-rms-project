...
class CreateTempPlugOnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_plug_ons', function (Blueprint $table) {
            ...
            $table->string('ts_local')->nullable();
    ...
    {
        Schema::dropIfExists('temp_plug_ons');
    }
}
