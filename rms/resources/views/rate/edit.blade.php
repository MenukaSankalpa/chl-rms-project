...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Edit rate</h1>

    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="{{url('/rate/'.$rate->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="box_owner_id"
                                    ...
                                    @foreach($box_owners as $box_owner)
                                        <option
                                            value="{{$box_owner->id}}" {{$box_owner->id == $rate->box_owner_id?'selected':''}}>{{$box_owner->name}}</option>
                                    @endforeach
                                </select>
