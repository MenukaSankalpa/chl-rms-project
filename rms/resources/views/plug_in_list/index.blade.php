                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group date" id="datetimepicker6"
                                                            ...
                                                            <input type="text" name="from_time"
                                                                   value="{{\Carbon\Carbon::now()->startOfDay()->toTimeString()}}"
                                                                   class="form-control form-control-sm datetimepicker-input"
                                                                   data-target="#datetimepicker6" tabindex="9"
                                                            />
                                                            <div class="input-group-append"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group date" id="datetimepicker7"
                                                            ...
                                                            <input type="text" name="to_time"
                                                                   value="{{\Carbon\Carbon::now()->endOfDay()->toTimeString()}}"
                                                                   class="form-control form-control-sm datetimepicker-input"
                                                                   data-target="#datetimepicker7" tabindex="9"
                                                            />
                                                            <div class="input-group-append"
        ...
        $(document).ready(function () {
            ...
            var table = $('#containerTable').DataTable({
                ...
                buttons: [{
                    extend: 'print',
                    autoPrint: false,
                    title: 'Plugged In Container List',
                    messageTop: function () {
                        return '<div class="row">' +
                            '<div class="col-md-3">From:</div> ' +
                            '<div class="col-md-3">'+$('input[name=from]').val()+'</div> ' +
                            '<div class="col-md-3">To:</div> ' +
                            '<div class="col-md-3">'+$('input[name=to]').val()+'</div> ' +
                            '</div>';
                ...
                columns: [
                    ...
                    // {data: 'schedule_4', orderable: false,"className": 'dt-right'},
                    // {data: 'schedule_8', orderable: false,"className": 'dt-right'},
                    // {data: 'schedule_12', orderable: false,"className": 'dt-right'},
                    // {data: 'schedule_16', orderable: false,"className": 'dt-right'},
                    // {data: 'schedule_20', orderable: false,"className": 'dt-right'},
                    // {data: 'schedule_24', orderable: false,"className": 'dt-right'},
