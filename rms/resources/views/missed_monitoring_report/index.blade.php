...
@section('content')
    ...
    <h1 class="h3 mb-4 text-gray-800">
        @section('_title')
            Missed Monitoring Report <small style="color: red">(Caution This report will take up to 4 minutes to process)</small>
        @show</h1>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <small style="font-weight: bold">date</small>
                                                        <input type="checkbox" class="" name="toggle_date"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm table-striped table-active"
                                    ...
                                    {{--<tr>--}}
                                        ...
                                        {{--<th rowspan="2">Set Temp</th>--}}
                                        {{--<th colspan="3">Plug on </th>--}}
        ...
        $(document).ready(function () {
            ...
            var table = $('#containerTable').DataTable({
                ...
                buttons: [{
                    ...
                    messageTop: function () {
                        return '<div class="row">' +
                            ...
                            '<h4><strong>MARINE SURVEY <br>TECHNOLOGY SERVICES (PVT) LTD.</strong></h4>' +
                            '</span>' +
                            '<p><small>1, Alfred House Avenue,<br>' +
                            'Colombo 3,<br>' +
                            'SRI LANKA</small></p>'+
                            '</div>' +
                            '<div class="col-md-4 row">' +
                            '<div class="col-md-12">'+
                            '<img class="float-right" style="width:75px" src="{{url('image/logo_login.png')}}"><br> ' +
                            '</div>' +
                            '<div class="col-md-12">' +
                            '<p class="float-right"><small>' +
                            'Tel: 0094 11 4 511080,<br>' +
                            'Fax: 0094 11 4 511087,<br>' +
                            'E-mail: manori@msts.lk' +
                            '</small></p>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '<div class="row"><div class="col-md-3">Plug On:</div> ' +
                ...
                columns: [
                    ...
                    // {data: 'ts_local'},
                    // {data: 'yard_location'},
                    {data: 'set_temp', orderable: false, searchable:false},
                    {data: 'plug_on_date'},
                    ...
                    {data: 'date', orderable: false, name:'reefer_monitorings.date'},
                    {data: 'schedule_4', orderable: false, name:'reefer_monitorings.schedule_4',"className": 'dt-right'},
                    {data: 'schedule_8', orderable: false, name:'reefer_monitorings.schedule_8',"className": 'dt-right'},
                    {data: 'schedule_12', orderable: false, name:'reefer_monitorings.schedule_12',"className": 'dt-right'},
                    {data: 'schedule_16', orderable: false, name:'reefer_monitorings.schedule_16',"className": 'dt-right'},
                    {data: 'schedule_20', orderable: false, name:'reefer_monitorings.schedule_20',"className": 'dt-right'},
                    {data: 'schedule_24', orderable: false, name:'reefer_monitorings.schedule_24',"className": 'dt-right'},
                ...
                @show
                language: {
                    processing: "<img style='width:20px;' src='{{url('/image/loading.gif')}}'>"
                },
                "ajax": {
                    "url": '{{url('data/missed_monitoring_report')}}',
                    "type": 'POST',
                    "data": function (d) {
