                                    ...
                                    <div class="col-md-12 mb-2{{-- border-right--}}" name="search_box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">Edit Plug off's</div>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="checkbox" class="" name="toggle_status"
                                                               data-col-index="8">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <small style="font-weight: bold">plug off</small>
                                                        <input type="checkbox" class="" name="toggl_plug_off"
                                                               data-col-index={15,16,17}>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <small style="font-weight: bold">delete</small>
                                                        <input type="checkbox" class="" name="toggle_delete"
                                                               data-col-index='20'>
                                                    </div>
                                                        @show
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#containerTable').DataTable({
                ...
                @show
                "ajax": {
                    "url": '{{url('data/reefer_monitoring')}}',
                    "type": 'POST',
                    "data": function (d) {
                ...
                $('tbody').find('input[name=plug_off_date]').each(function(k,v){
                    ...
                    if($('input[name=toggl_plug_off]').is(':checked')){
                        if($(v).data('status')==0){//monitoring plugged off
                            //if plug off date stays the same
                        }else if($(v).data('status')==7){//if plug on off only
                            if($(v).val()==='') {//if date is empty
                                $(v).val($('input[name=date]').val());//current search date
                            }
                        }else{
                            $(v).val($('input[name=date]').val());//for other categories current search date
                        }
                    }else{
                        $(v).val('');
                    }
...
///on plug on of only button toggle.
            $('#containerTable').delegate('input[name=plugging_category]','click',function (e) {
               ...
               $.ajax({
                   ...
                   data:$(this).serialize()
                    ...
                    if(typeof d =='string' && 'error' in JSON.parse(d)){
                        $.notify(
                            JSON.parse(d).error,
                            {
                                globalPosition: "bottom left",
                    ...
                    }else if(d.reefer_monitoring.length<1) {
                        $.notify(
            ...
            function quic_save_validation(tr) {
                ...
                // if($('input[name=toggl_plug_off]').is(':checked')&& (status!=0&&status!=7)){
